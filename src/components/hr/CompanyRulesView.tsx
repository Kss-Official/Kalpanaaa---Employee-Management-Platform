...
const DEFAULT_RULES: CompanyRuleItem[] = [
  ...
  },
  {
    id: 'rule-5',
    category: 'Employee Rules',
    title: 'Paid Time Off (PTO) & Weekly Offs',
    description: 'Every Sunday is an official Weekly Off. In addition, 17 declared Indian National, State (Karnataka Rajyotsava), and Festival Holidays are recognized as paid non-working days.',
    effectiveDate: '2026-01-01',
    isMandatory: true
  }
];
