...
const DEFAULT_COMPANY_RULES: Array<Pick<WorkplaceRule, 'title' | 'description'>> = [
  ...
  { title: 'Leave Approval Policy', description: 'Earn leaves start at strictly 0 and 1 Earn Leave is credited on the 1st date of every month. Employees also receive 1 Sick Leave day for the 3-month traineeship and 1 Sick Leave day every 3 months recurring thereafter. All leave and work-from-home requests must be raised in advance and approved via the multi-stage hierarchy.' },
