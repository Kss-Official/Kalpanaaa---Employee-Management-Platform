/**
 * Set initialPassword on emp-KSS2407011 so HR can log in
 */
...
async function main() {
  ...
  console.log('Setting initialPassword: "Hr@123456" on employees/emp-KSS2407011...');
  await patchDoc('employees', 'emp-KSS2407011', {
    initialPassword: 'Hr@123456',
    failedLoginCount: '0',
    updatedAt: new Date().toISOString()
  }, token);
  console.log('✅ initialPassword set on emp-KSS2407011!');
}
