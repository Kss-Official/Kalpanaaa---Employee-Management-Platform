/**
 * Deactivate / clean up duplicate Abhinaya profile 3ZHI3aTB37StHjR97WEBJQSWT9H3
 */
...
async function main() {
  ...
  console.log('Deactivating duplicate employee doc 3ZHI3aTB37StHjR97WEBJQSWT9H3...');
  try {
    await patchDoc('employees', '3ZHI3aTB37StHjR97WEBJQSWT9H3', {
      status: 'Inactive',
      employeeId: '',
      qrToken: '',
      updatedAt: new Date().toISOString()
    }, token);
    console.log('✅ Successfully marked 3ZHI3aTB37StHjR97WEBJQSWT9H3 as Inactive & cleared employeeId!');
  } catch (e) {
